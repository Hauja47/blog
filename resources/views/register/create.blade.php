        ...
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border-gray-200 p-6 rounded-xl">
            ...
            <form action="/register" method="POST" class="mt-10">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" class="border border-grey-400 p-2 w-full" name="name" id="name" value="{{
                        old('name') }}" required>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" class="border border-grey-400 p-2 w-full" name="username" id="usename" value="{{ old('username') }}" required>
                ...
                <div class="mb-6">
                    ...
                    <input type="email" class="border border-grey-400 p-2 w-full" name="email" id="email" value="{{
                        old('email') }}" required>
